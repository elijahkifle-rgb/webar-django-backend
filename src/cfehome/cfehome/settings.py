...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-j)n-e#b#226aviwwu!f!mhy7cya467+pbbs8^jigbmmt#8d)^(')
...
CSRF_TRUSTED_ORIGINS = ['https://webar-django-backend-production-377c.up.railway.app']
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')

# --- DEBUG PRINTS (visible in Railway logs) ---
import sys
print("="*60, file=sys.stderr)
print("LOADING LATEST SETTINGS WITH CSRF_FIX", file=sys.stderr)
